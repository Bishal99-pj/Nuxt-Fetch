...
stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- search field  -->
                <input
id="input-group-search" v-model="query" type="search"
...
v-if="filteredOptions.length === 0 && query !== ''"
        ...
        <ul class="px-3 pb-3 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200">
            <li v-for="option in filteredOptions" :key="option.id">
                <div
class="flex items-center ps-2 rounded hover:bg-green-300 transition-colors duration-100 hover:font-semibold dark:hover:bg-gray-600"
